...
%>
		<table>
			<tr>
<%
			if(isAdmin || slUserDept.contains("HRM"))
			{
%>
				<td align="left">
...
%>
		<table width="100%">
			<tr>
				<td style="text-align:center;background-color:#bbbbbb;font-size:12px;font-family:Arial,sans-serif"><%= resourceBundle.getProperty("DataManager.DisplayText.No_Users") %></td>
			</tr>
		</table>
<%
	}
...
%>
	<table width="100%">
		<tr>
			<td style="text-align:center;background-color:#bbbbbb;font-size:12px;font-family:Arial,sans-serif"><%= resourceBundle.getProperty("DataManager.DisplayText.Users_Search_Msg") %></td>
		</tr>
	</table>
<%
}
