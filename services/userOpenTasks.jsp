...
%>
			...
			<tr>
				<th class="label" width="3%"><input type="checkbox" id="chk_all" name="chk_all" onClick="javascript:checkAll()"></th>
				<th class="label" width="7%"><%= resourceBundle.getProperty("DataManager.DisplayText.Task_Name") %></th>
				...
				<th class="label" width="15%"><%= resourceBundle.getProperty("DataManager.DisplayText.Owner") %></th>
				<th class="label" width="7%"><%= resourceBundle.getProperty("DataManager.DisplayText.Parent_Task") %></th>		
				<th class="label" width="9%"><%= resourceBundle.getProperty("DataManager.DisplayText.Estimated_Start") %></th>
				<th class="label" width="9%"><%= resourceBundle.getProperty("DataManager.DisplayText.Estimated_End") %></th>
				<th class="label" width="9%"><%= resourceBundle.getProperty("DataManager.DisplayText.Actual_Start") %></th>
				<th class="label" width="9%"><%= resourceBundle.getProperty("DataManager.DisplayText.Actual_End") %></th>
				<th class="label" width="5%"><%= resourceBundle.getProperty("DataManager.DisplayText.Deliverables") %></th>
				<th class="label" width="4%"><%= resourceBundle.getProperty("DataManager.DisplayText.WBS") %></th>
			</tr>
<%
			boolean bFg = true;
			...
			for(int i=0; i<iSz; i++)
			{
				...
				if(!("".equals(sChildTasks) || "0".equals(sChildTasks)) && bFg)
				{
					bFg = false;
%>
					<tr><th class="label" colspan="13">&nbsp;</th></tr>
<%
				}
%>
				<tr>
