 ...
 */
            ...
            /**
            *  GetLogDataInline bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLogDataInline
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetLogDataInline",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetLogDataInline",
    ...
    public static class Factory{
        ...
        */
        public static GetLogDataInline parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLogDataInline object =
                new GetLogDataInline();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetLogDataInline".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLogDataInline)com.resourcedm.www.rdmplanttdb._2022._04._07.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
