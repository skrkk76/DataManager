 ...
 */
                ...
                "ns1");
                        ...
                        */
                            ...
                            // Constructor
                                ...
                                protected ResponseType(java.lang.String value, boolean isRegisterValue) {
                                    localResponseType = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localResponseType, this);
                                ...
                                public static final ResponseType Csv =
                                    new ResponseType(_Csv,true);
                            
                                public static final ResponseType Xml =
                                    new ResponseType(_Xml,true);
                            

                                public java.lang.String getValue() { return localResponseType;}

                                public boolean equals(java.lang.Object obj) {return (obj == this);}
                                public int hashCode() { return toString().hashCode();}
                                public java.lang.String toString() {
                                
                                        return localResponseType.toString();
    ...
    public static class Factory{
                ...
                public static ResponseType fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static ResponseType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return ResponseType.Factory.fromString(content,namespaceUri);
                    } else {
                       return ResponseType.Factory.fromString(content,"");
                    }
                }
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = ResponseType.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = ResponseType.Factory.fromString(content,"");
                                        }
