...
public class NotifyAlarms extends RDMServicesConstants
{
    ...
    public void addNotificationAlarm(String sAlarm, String sCntrlType, String sNotifyBy, String sGroup, int notifyDuration) throws Exception
	{
		DataQuery query = new DataQuery();
    ...
    public void updateNotificationAlarm(String sAlarm, String sCntrlType, String sNotifyBy, String sGroup, int notifyDuration) throws Exception
	{
		DataQuery query = new DataQuery();
