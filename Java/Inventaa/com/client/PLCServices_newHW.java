...
import com.resourcedm.www.rdmplanttdb._2022._04._07.ArrayOfItems;
import com.resourcedm.www.rdmplanttdb._2022._04._07.ArrayOfSettings;
import com.resourcedm.www.rdmplanttdb._2022._04._07.Event;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetAlarmList;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetAlarmListResponse;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetLogDataInline;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetLogDataInlineResponse;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetSlave;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetSlaveResponse;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetSyslog;
import com.resourcedm.www.rdmplanttdb._2022._04._07.GetSyslogResponse;
import com.resourcedm.www.rdmplanttdb._2022._04._07.Item;
import com.resourcedm.www.rdmplanttdb._2022._04._07.LogData;
import com.resourcedm.www.rdmplanttdb._2022._04._07.RDMPlantTDBServicesSoapStub;
import com.resourcedm.www.rdmplanttdb._2022._04._07.ResponseType;
import com.resourcedm.www.rdmplanttdb._2022._04._07.SetSlave;
import com.resourcedm.www.rdmplanttdb._2022._04._07.SetSlaveResponse;
import com.resourcedm.www.rdmplanttdb._2022._04._07.Setting;
import com.resourcedm.www.rdmplanttdb._2022._04._07.SlaveDetail;
import com.resourcedm.www.rdmplanttdb._2022._04._07.UserCredentials;
import com.resourcedm.www.rdmplanttdb._2022._04._07.UserCredentialsE;

public class PLCServices_newHW extends PLCServices {
    ...
    public PLCServices_newHW(ServicesSession session, String controller) throws Exception {
	this.sController = controller;
	this.session = session;
	sCntrlType = RDMServicesUtils.getControllerType(controller);
	...
	if (session.checkConnectionIsAlive(controller)) {
	    ...
	    throw new ConnectException(
		    "Controller " + controller + " connection not available, please check with the Administrator");
	}
    }
	...
	RDMPlantTDBServicesSoapStub stub = getStub(controller);
	if (stub != null) {
	...
	RDMPlantTDBServicesSoapStub stub = getStub(this.sController);
	if (stub != null) {
	    GetSlave getSlave = new GetSlave();
	    GetSlaveResponse getSlaveResp = stub.getSlave(getSlave);
	    SlaveDetail slaveDetail = getSlaveResp.getGetSlaveResult();
	...
	String realTime = RDMServicesUtils.getProperty("rdmservices.controller.realtime");
	if ("false".equalsIgnoreCase(realTime)) {
	    isRealTime = false;
	}
	...
	while (itr.hasNext()) {
		...
		if (stageParam.startsWith("set ")) {
		    minParam = stageParam.replace("set ", "min ");
		    ...
		    maxParam = stageParam.replace("set ", "max ");
    ...
    public TreeMap<String, Map<String, String>> getImageControllerData(Map<String, String[]> mParams, String sParamKey,
	    String sSelPhase) throws Exception {
	...
	SetSlaveResponse setSlaveResp = getStub(sController).setSlave(setSlave, getCredentials());
	...
	for (int i = 0; i < datesBetween.size(); i++) {
	    ...
	    GetLogDataInlineResponse getLogDataResp = getStub(sController).getLogDataInline(getLogDataInline);
	...
	GetSyslogResponse getSyslogResp = getStub(sController).getSyslog(getSysLog, getCredentials());
	...
	String sEncryted = encryptDecrypt.encryptWithSHA(sCntrlPwd);

	UserCredentials userCredentials = new UserCredentials();
	userCredentials.setUserName(sCntrlUID);
	userCredentials.setPassword(sEncryted);
	...
	for (int i = alCntrlStgs.size() - 1; i >= 0; i--) {
	    dPhaseSeq = Double.parseDouble((alCntrlStgs.get(i)[0]).replace(" ", "."));
