 ...
 */
            ...
            /**
            *  OverrideGPTimerChannel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OverrideGPTimerChannel
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OverrideGPTimerChannel",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OverrideGPTimerChannel",
    ...
    public static class Factory{
        ...
        */
        public static OverrideGPTimerChannel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OverrideGPTimerChannel object =
                new OverrideGPTimerChannel();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OverrideGPTimerChannel".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OverrideGPTimerChannel)com.resourcedm.www.rdmplanttdb._2022._04._07.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.resourcedm.com/RDMPlantTDB/2022/04/07/","Duration").equals(reader.getName())){
