 ...
 */
            ...
            /**
            *  GetSyslog bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSyslog
    ...
    public static class Factory{
        ...
        */
        public static GetSyslog parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSyslog object =
                new GetSyslog();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetSyslog".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSyslog)com.resourcedm.www.rdmplanttdb._2009._03._13.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
