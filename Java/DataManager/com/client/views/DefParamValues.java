...
public class DefParamValues extends RDMServicesConstants {
	...
	public Map<String, String> getDefaultParamValues(String sCntrlType, String sDefType, String sParam)
			throws Exception {
		DataQuery query = new DataQuery();
		return query.getDefaultParamValues(sCntrlType, sDefType, sParam);
	}

	public void updateDefaultParamValues(String sCntrlType, Map<String, Map<String, String>> mCntrlDefValues)
			throws Exception {
		String sDefType = null;
		Map<String, String> mDefValues = null;
