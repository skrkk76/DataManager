...
public class BatchPhaseLoad extends RDMServicesConstants {
    ...
    public String loadBatchPhaseGraph(String sMonth, String sYear, String sCntrlType, String sProductType,
	    StringList slBatches) throws Exception {
	...
	Map<String, String> mDefaultDurations = defParamVal.getDefaultParamValues(sCntrlType, sProductType,
		SET_DURATION);
    ...
    public String exportBatchPhaseGraph(String sMonth, String sYear, String sCntrlType, String sProductType,
