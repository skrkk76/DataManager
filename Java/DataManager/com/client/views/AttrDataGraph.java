...
public class AttrDataGraph extends RDMServicesConstants {
	...
	public String loadAttrDataGraph(String sController, String[] saParams, String sStartDt, String sEndDt,
			boolean bYield) throws Exception {
		return getAttrDataGraphCSV(sController, saParams, sStartDt, sEndDt, bYield, false);
	}

	public String exportAttrDataGraph(String sController, String[] saParams, String sStartDt, String sEndDt,
			boolean bYield) throws Exception {
		return getAttrDataGraphCSV(sController, saParams, sStartDt, sEndDt, bYield, true);
	}

	private String getAttrDataGraphCSV(String sController, String[] saParams, String sStartDt, String sEndDt,
		...
		File f = File.createTempFile(sController.replace(" ", ""), ".csv", new File(sPath));
