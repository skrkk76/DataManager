...
public class GetComputerID {
    ...
    public static String getWinUUID() throws IOException {
    ...
    public static String getLinuxUUID() throws IOException {
	Process process = Runtime.getRuntime().exec("cat /sys/class/dmi/id/product_uuid");
	BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()));
	return reader.readLine();
    }

    public static String getMacUUID() throws IOException {
