 ...
 */
            ...
            /**
            *  GetGPTimerChannel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetGPTimerChannel
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetGPTimerChannel",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetGPTimerChannel",
    ...
    public static class Factory{
        ...
        */
        public static GetGPTimerChannel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetGPTimerChannel object =
                new GetGPTimerChannel();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetGPTimerChannel".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetGPTimerChannel)com.resourcedm.www.rdmplanttdb._2009._03._13.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
