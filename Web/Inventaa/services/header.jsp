...
if(showContent == null || "".equals(showContent))
{
	...
	mHomePage.put(RDMServicesConstants.VIEWS_GRAPH_PRODUCTIVITY, "productivityGraphView.jsp");
	...
	mHomePage.put(RDMServicesConstants.VIEWS_TASKS, "userTasksView.jsp");
	mHomePage.put(RDMServicesConstants.VIEWS_YIELDS, "viewYields.jsp");
	mHomePage.put(RDMServicesConstants.VIEWS_REPORTS, "viewReportsView.jsp");
	mHomePage.put(RDMServicesConstants.VIEWS_TIMESHEETS, "manageTimesheetsView.jsp");
...
<%
							...
							{
%>	
								<li><a href="javascript:reloadHeader('employeeInOutView.jsp')" class="first">
									<%= resourceBundle.getProperty("DataManager.DisplayText.Attendance") %></a>
								</li>
								<li><a href="javascript:reloadHeader('viewReportsView.jsp')">
...
<%
									...
									{
%>
										<li><a href="#"><%= resourceBundle.getProperty("DataManager.DisplayText.Graph") %> &raquo;</a>
											<ul>
<%
											if(bViewAttrGraph)
											{
%>
												<li><a href="javascript:reloadHeader('attrDataGraphView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Attribute_Data") %></a></li>
<%
											}
											if(bViewProdGraph)
											{
%>
												<li><a href="javascript:reloadHeader('productivityGraphView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Productivity") %></a></li>
<%
											}
											if(bViewBatchLoad)
											{
%>
												<li><a href="javascript:reloadHeader('batchPhaseLoadsView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Batch_Phase_Loads") %></a></li>
<%
											}
%>
											</ul>
...
<%
									...
									{
%>	
										<li><a href="javascript:reloadHeader('userTasksView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Tasks") %></a></li>
<%
									}
									if(bViewYields)
									{
%>
										<li><a href="javascript:reloadHeader('viewYields.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Yields") %></a></li>
<%
									}
									if(bViewReports)
									{
...
<%
									...
									{									
%>
										<li><a href="javascript:reloadHeader('manageTimesheetsView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Manage_Timesheets") %></a></li>
<%
									}
...
<%
									...
									{									
%>
										<li><a href="javascript:reloadHeader('../custom/polmonDL120Details.jsp')">
											<%= com.client.polsoft.PolsoftClient.getProperty("polsoft.DisplayText.PolmonDL120") %>
										</a></li>
<%
									}
%>
...
%>							
								<li><a href="#"><%= resourceBundle.getProperty("DataManager.DisplayText.Admin") %> &raquo;</a>
									<ul>
										...
										<li><a href="#"><%= resourceBundle.getProperty("DataManager.DisplayText.Task_Management") %> &raquo;</a>
											<ul>
												<li><a href="javascript:reloadHeader('manageAdminTasksView.jsp')">
													<%= resourceBundle.getProperty("DataManager.DisplayText.ManageTasks") %>
												</a></li>
												<li><a href="javascript:reloadHeader('manageAdminAttributesView.jsp')">
													<%= resourceBundle.getProperty("DataManager.DisplayText.ManageAttributes") %>
												</a></li>
											</ul>
										</li>
										...
										<li><a href="javascript:reloadHeader('manageWeighingScalesView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.ManageScales") %></a></li>
