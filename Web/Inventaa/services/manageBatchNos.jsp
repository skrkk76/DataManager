	...
	<form name="frm" method="post" action="manageBatchNoResults.jsp">
		<table align="center" border="0" cellpadding="1" cellspacing="1" width="90%">
			<tr>
				...
				<td align="center">
					<input type="button" name="search" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Show_Batch_Nos") %>" onClick="showBatchNos()">
				</td>
				
				<td align="center">
					<input type="button" name="refresh" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Refresh") %>" onClick="refreshBatchNos()">
				</td>
				
				<td align="right">
					<input type="button" id="expBatchNos" name="expBatchNos" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Export_to_File") %>" onClick="exportBatchNos()">
				</td>
			</tr>
		</table>
	</form>
	
	<iframe name="results" src="manageBatchNoResults.jsp" align="middle" frameBorder="0" width="100%" height="<%= winHeight * 0.8 %>px">
</body>
</html>
