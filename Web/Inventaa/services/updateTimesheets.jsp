...
<body>
	<form name="frm" method="post" action="updateTimesheetsProcess.jsp">
		...
		<table align="center" border="0" cellpadding="1" cellspacing="1">
			...
			<tr>
				<td class="label"><%= resourceBundle.getProperty("DataManager.DisplayText.User_Name") %></td>
				<td class="input" colspan="4"><%= mUsers.get(sUserId) %>&nbsp;(<%= sUserId %>)</td>
			</tr>
			<tr>
				<td class="label"><%= resourceBundle.getProperty("DataManager.DisplayText.Shift") %></td>
			...
			<tr>
				<td align="left">
					<input type="button" name="save" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Save") %>" onClick="saveTimesheet()">
				</td>
				<td colspan="3">&nbsp;</td>
				<td align="right">
					<input type="button" name="delete" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Delete") %>" <%= "".equals(sOID) ? "disabled" : "" %> onClick="deleteTimesheet()">
				</td>
			</tr>
		</table>
	</form>
