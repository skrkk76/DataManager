...
<%
					String sParams = "";
					if(slGraphs.contains("Tunnel Dashboard"))
					{
						Map<String, String> mGraphParams = u.getGraphParams("Tunnel Dashboard");
...
%>
		...
		<form name="frm" method="post" action="setParametersProcess.jsp" target="hiddenFrame">
			...
			<table width="1300px" height="900px" cellspacing="0" cellpadding="0" border="0" align="left" background="../images/TunnelView.jpg" style="background-repeat:no-repeat">
				<tr>
