...
<head>
	...
	<script language="javascript">
		...
		function editDepartment(i)
		{
			...
			parent.frames['footer'].document.location.href = "manageDepartmentProcess.jsp?name="+name.value+"&oldName="+oldName+"&desc="+desc.value+"&status="+status+"&mode=edit";
		}
...
<body>
	<form name="frm">
		<table align="center" border="0" cellpadding="2" cellspacing="1" width="<%= winWidth * 0.2 %>">
			<tr>
				<td colspan="4" style="text-align: right;"><input type="button" name="Add" value="<%= resourceBundle.getProperty("DataManager.DisplayText.Add_Department") %>" onClick="addDepartment()"></td>
			</tr>
			<tr>
