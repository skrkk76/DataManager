...
<%
							...
							boolean bManager = RDMServicesConstants.ROLE_MANAGER.equals(u.getRole());
							if(bAdmin || u.manageUsers() || u.manageAlarms())
							{
%>
...
<%
									...
									if(bAdmin || u.manageUsers())
									{
%>
										<li><a href="javascript:reloadHeader('manageUsersView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Manage_Users") %></a></li>
<%
									}
									if(bAdmin)
									{
%>
										<li><a href="javascript:reloadHeader('manageDepartmentsView.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Departments") %></a></li>
										<li><a href="javascript:reloadHeader('manageUserViews.jsp')"><%= resourceBundle.getProperty("DataManager.DisplayText.Manage_User_Views") %></a></li>
...
<%
									...
									if(bAdmin || (bManager && u.manageUsers()))
									{
%>
